...
os.environ["OPENAI_API_KEY"] = "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"
    ...
    with gr.Column():
        with gr.Row():
            with gr.Column(scale=0.8):
                api_key = gr.Textbox(placeholder='Enter OpenAI API key', show_label=False, interactive=True).style(
                    container=False)
